...
@section('contents')
    <div class="container">
        <a href="{{ route('admin.tambahkontak') }}">
        ...
        <div class="row">
            <div class="col d-flex justify-content-center">
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        <h5 class="card-title text-center">Tambah Kontak</h5>
                        <form action="{{ route('postTambahKontak') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mt-4">
                                ...
                                <textarea class="form-control" name="maps_url" rows="4" required>{{ old('maps_url') }}</textarea>
                                <span class="text-danger">
                                    @error('maps_url')
                                        {{ $message }}
                                    @enderror
